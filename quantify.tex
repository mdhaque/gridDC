...
\xynote{
Configuration for the three cases:
(1)wind speeds for the existing aggregated wind farms are set to MEDIUM(9m/s).
(2) the size of the additional data center is set to 100MW.
(3) For Case 2, the additional data center is located onto bus 18. For Case 3, the data center is located onto bus 10.
}
