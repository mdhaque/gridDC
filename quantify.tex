...
\begin{figure}[hb]
\centering
\includegraphics[width=1\columnwidth]{img/loss3cases_w_CI.pdf}
\caption{Results of system losses \red{with 95\% confidence intervals}}
\label{fig:loss-cases}
\end{figure}

By comparing the values of system losses \red{together with the 95\% confidence intervals} from Figure~\ref{fig:loss-cases}, it can be observed that the co-location case (Case 2) could lead to more losses than Case 1 and Case 3. Take MEDIUM setting for example, the system losses of Case 3 is about 6\% less than Case 2, which illustrates system loss can be reduced by placing the datacenter correctly and co-location is not necessarily the best choice.
